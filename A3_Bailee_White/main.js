  ...
  // let logoMain  = document.querySelector ('.cls1')
  // let logoSecondS  = document.querySelector ('.cls2')
...
// let section9 = document.querySelector ('#s9')
...
// };
	...
	// section9.onmouseover= function(){
	// 	audio.play();
	// }
	// section9.onmouseout= function(){
	// 	audio.pause();
	// }   
